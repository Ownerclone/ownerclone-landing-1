          ...
          <div className="max-w-7xl mx-auto">
            <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 mb-12">
              ...
              <p className="text-xl text-gray-300 text-center mt-4">
                We don&apos;t just sell you software—we guarantee your success
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
              ...
              {/* Right Column - ROI Guarantee */}
              <div className="backdrop-blur-xl bg-gradient-to-br from-green-500/10 to-emerald-500/10 border-2 border-green-400/30 rounded-2xl p-8">
                <h3 className="text-2xl font-bold mb-6 text-green-400">The OwnerClone Honesty Advantage</h3>
                
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    <div className="flex-shrink-0">
                      <div className="w-12 h-12 bg-green-400/20 text-green-400 rounded-full flex items-center justify-center text-xl font-bold">✓</div>
                    </div>
                    <div>
                      <h4 className="text-lg font-bold mb-2 text-gray-200">We Track Your ROI Continuously</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="text-lg font-bold mb-2 text-gray-200">150% ROI Guarantee</h4>
                      <p className="text-gray-400">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="text-lg font-bold mb-2 text-gray-200">Consultant Built In for Your Protection</h4>
                      <p className="text-gray-400">
                ...
                <div className="mt-8 p-6 backdrop-blur-xl bg-green-400/10 border border-green-400/30 rounded-lg">
