          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="bg-[#0a0a0a]/60 backdrop-blur-xl border border-[#2a2a2a] rounded-2xl p-8">
              ...
              <form action="https://formspree.io/f/meeeeevo" method="POST" className="space-y-6">
                ...
                <input type="hidden" name="_subject" value="New OwnerClone Contact" />

                <button
                  type="submit"
                  className="w-full bg-[#38bdf8] text-black px-6 py-4 rounded-lg font-bold text-lg hover:bg-[#0ea5e9] transition-colors"
                >
                  Send Message
                </button>
              </form>
            ...
            <div className="space-y-8">
              <div className="bg-gradient-to-br from-[#10b981]/20 to-[#10b981]/5 border-2 border-[#10b981] rounded-2xl p-6">
                ...
                <p className="text-gray-300 mb-4">
                  ...
                  href="mailto:info@ownerclone.com"
                  className="block w-full text-center px-6 py-4 bg-[#10b981] text-black font-bold rounded-lg hover:bg-[#059669] transition-colors"
                >
              ...
              <div className="bg-[#0a0a0a]/60 backdrop-blur-xl border border-[#2a2a2a] rounded-2xl p-6">
                ...
                <div className="space-y-3">
                  <Link href="/pricing" className="block text-[#38bdf8] hover:text-[#0ea5e9] font-semibold">
                    View Pricing
                  </Link>
                  <Link href="/features" className="block text-[#38bdf8] hover:text-[#0ea5e9] font-semibold">
                    Explore Features
                  </Link>
                  <Link href="/roadmap" className="block text-[#38bdf8] hover:text-[#0ea5e9] font-semibold">
                    Product Roadmap
                  </Link>
                  <Link href="/blog" className="block text-[#38bdf8] hover:text-[#0ea5e9] font-semibold">
                    Read Blog
                  </Link>
                </div>
              </div>
      ...
      <section className="relative py-16 px-4 bg-[#0f1419]/30">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-300">
            Built by restaurant owners who understand your challenges. We typically respond within 24 hours.
          </p>
        </div>
      </section>
    </div>
