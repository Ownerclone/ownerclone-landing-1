    ...
    <div className="min-h-screen text-white">
      <section className="relative pt-32 pb-16 px-4">
        <div className="relative max-w-4xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-black mb-6">Let's <span className="text-[#38bdf8]">Talk</span></h1>
          <p className="text-xl text-gray-300">Questions? Feedback? Feature requests? We're here.</p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="backdrop-blur-xl bg-white/5 border border-[#2a2a2a] rounded-2xl p-8">
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button type="submit" disabled={isSubmitting} className="w-full bg-[#38bdf8] text-black px-6 py-4 rounded-lg font-bold text-lg hover:bg-[#0ea5e9] transition-colors shadow-lg hover:shadow-[0_0_40px_rgba(56,189,248,0.3)] disabled:opacity-50 disabled:cursor-not-allowed">
            ...
            <div className="space-y-8">
              <div className="bg-gradient-to-br from-[#10b981]/20 to-[#10b981]/5 border-2 border-[#10b981] rounded-2xl p-6 backdrop-blur-xl">
                ...
                <p className="text-gray-300 mb-4">Upgrade your POS system and get OwnerClone included at no cost.</p>
                <ul className="space-y-2 text-gray-300 mb-6">
                  <li className="flex items-start"><span className="text-[#10b981] mr-2">✓</span><span>Switch to Toast or Skytab POS</span></li>
                  <li className="flex items-start"><span className="text-[#10b981] mr-2">✓</span><span>Get OwnerClone included free</span></li>
                  <li className="flex items-start"><span className="text-[#10b981] mr-2">✓</span><span>Save $200-400/month</span></li>
                </ul>
                <a href="/pricing" className="block w-full text-center bg-[#10b981] text-black px-6 py-3 rounded-lg font-bold hover:bg-[#059669] transition-colors">Learn More</a>
              </div>
              ...
              <div className="backdrop-blur-xl bg-white/5 border border-[#2a2a2a] rounded-2xl p-6">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-[#38bdf8] rounded-lg flex items-center justify-center flex-shrink-0 text-2xl">📧</div>
                    <div>
                      <h4 className="font-semibold text-white mb-1">Email</h4>
                      <a href="mailto:hello@ownerclone.com" className="text-[#38bdf8] hover:text-[#0ea5e9] transition">hello@ownerclone.com</a>
                    </div>
                  </div>
              ...
              <div className="backdrop-blur-xl bg-white/5 border border-[#2a2a2a] rounded-2xl p-6">
                ...
                <div className="space-y-3">
                  <a href="/pricing" className="block text-gray-300 hover:text-[#38bdf8] transition">→ View Pricing</a>
                  <a href="/features" className="block text-gray-300 hover:text-[#38bdf8] transition">→ See Features</a>
                  <a href="/roadmap" className="block text-gray-300 hover:text-[#38bdf8] transition">→ Product Roadmap</a>
                  <a href="/free-tools" className="block text-gray-300 hover:text-[#38bdf8] transition">→ Free Calculator Tools</a>
                </div>
              </div>

              <div className="backdrop-blur-xl bg-white/5 border border-[#2a2a2a] rounded-2xl p-6">
                <h4 className="font-semibold text-white mb-2">For Media Inquiries</h4>
                <a href="mailto:press@ownerclone.com" className="text-[#38bdf8] hover:text-[#0ea5e9] transition">press@ownerclone.com</a>
              </div>
            </div>
          </div>
        </div>
