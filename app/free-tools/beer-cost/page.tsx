...
export default function BeerCostCalculator() {
  const [kegSize, setKegSize] = useState<'sixth' | 'quarter' | 'half'>('half')
  const [kegCost, setKegCost] = useState('')
  const [servingSize, setServingSize] = useState<'10' | '12' | '16' | '20' | '64'>('16')
  ...
  const getServingsForSize = (oz: number) => {
      ...
      <div className="relative z-10 container mx-auto px-4 pt-24 pb-8 max-w-4xl">
        ...
        <div className="mb-8">
          <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 shadow-[0_0_50px_rgba(245,158,11,0.1)]">
            <h1 className="text-4xl md:text-5xl font-black mb-4">Draft Beer <span className="text-[#f59e0b]">Cost Calculator</span></h1>
            <p className="text-xl text-gray-300">Calculate pour cost, profit per pint, and total keg profit for your draft beer program</p>
          </div>
        </div>
        ...
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 shadow-[0_0_50px_rgba(245,158,11,0.1)]">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div>
              ...
              <select value={kegSize} onChange={(e) => setKegSize(e.target.value as 'sixth' | 'quarter' | 'half')}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="number" step="0.01" placeholder="180.00" value={kegCost} onChange={(e) => setKegCost(e.target.value)}
            ...
            <div>
              ...
              <select value={servingSize} onChange={(e) => setServingSize(e.target.value as '10' | '12' | '16' | '20' | '64')}
                className="w-full px-4 py-3 bg-[#0a0a0a] border-2 border-[#2a2a2a] rounded-lg focus:border-[#f59e0b] focus:outline-none text-white text-lg transition-colors">
            ...
            <div>
              ...
              <div className="relative">
                <span className="absolute left-4 top-3 text-gray-500 text-lg">$</span>
                <input type="number" step="0.01" placeholder="6.00" value={sellingPrice} onChange={(e) => setSellingPrice(e.target.value)}
                  className="w-full pl-10 pr-4 py-3 bg-[#0a0a0a] border-2 border-[#2a2a2a] rounded-lg focus:border-[#f59e0b] focus:outline-none text-white text-lg transition-colors" />
              </div>
            </div>
          </div>
          ...
          <div className="mb-8 p-6 bg-[#0a0a0a]/50 rounded-lg border border-[#2a2a2a]">
            ...
            <input type="range" min="5" max="20" step="1" value={wasteFactor} onChange={(e) => setWasteFactor(e.target.value)}
            ...
            <div className="border-t-2 border-[#2a2a2a] pt-8">
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="backdrop-blur-xl bg-[#10b981]/10 border border-[#10b981]/30 rounded-lg p-6 text-center">
                  <p className="text-sm font-semibold text-gray-300 mb-2">PROFIT PER SERVING</p>
              ...
              {lostProfit > 0 && (
                <div className="backdrop-blur-xl bg-[#ef4444]/10 border border-[#ef4444]/30 rounded-lg p-6 mb-8">
                  ...
                  <p className="text-gray-300">
                    At {wasteFactor}% waste, you lose <strong className="text-[#ef4444]">{lostServings} servings</strong> per keg = <strong className="text-[#ef4444]">${lostProfit.toFixed(2)}</strong> lost profit.
                  </p>
                  <p className="text-gray-400 mt-2 text-sm">
                    Reducing waste by 5% saves ${((servingsBeforeWaste * 0.05) * profitPerServing).toFixed(2)} per keg!
                  </p>
                </div>
              )}
              ...
              <div className="backdrop-blur-xl bg-[#f59e0b]/10 border border-[#f59e0b]/30 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-gray-300">
                  <li className="flex items-start gap-2">
                    ...
                    <span><strong>Train staff on proper pours</strong> - A 45° angle pour reduces foam</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#f59e0b]">•</span>
                    <span><strong>Clean draft lines bi-weekly</strong> - Dirty lines cause excess foam</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#f59e0b]">•</span>
                    <span><strong>Check CO2 pressure</strong> - Incorrect pressure is #1 cause of foam</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#f59e0b]">•</span>
                    <span><strong>Keep kegs cold</strong> - Maintain 36-38°F</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="mt-8 bg-gradient-to-r from-[#f59e0b] to-[#fbbf24] rounded-xl shadow-lg p-8 text-center text-black">
            ...
            <p className="text-lg mb-6 text-black/70">OwnerClone tracks pour costs and alerts you when waste spikes</p>
            <Link href="/demo" className="inline-block bg-black text-[#f59e0b] px-8 py-4 rounded-lg font-bold text-lg hover:bg-gray-900 transition-colors">
              Start Free Trial →
            </Link>
          </div>
        </div>
