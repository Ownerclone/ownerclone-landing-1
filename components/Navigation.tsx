  ...
  <circle cx="48" cy="30" r="18" fill="none" stroke="#38bdf8" strokeWidth="10" strokeDasharray="85 113" transform="rotate(40, 48, 30)"/>
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 w-72 bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                  <div className="p-2">
                    <Link href="/free-tools/food-cost" className="flex items-center gap-3 px-4 py-3 text-gray-300 hover:bg-[#2a2a2a] hover:text-white rounded-lg transition-colors">
                    ...
                    <Link href="/free-tools/prime-cost" className="flex items-center gap-3 px-4 py-3 text-gray-300 hover:bg-[#2a2a2a] hover:text-white rounded-lg transition-colors">
                      <span className="text-2xl">📊</span>
                      <div>
                    ...
                    <Link href="/free-tools/labor-cost" className="flex items-center gap-3 px-4 py-3 text-gray-300 hover:bg-[#2a2a2a] hover:text-white rounded-lg transition-colors">
                      <span className="text-2xl">👥</span>
                      <div>
                    ...
                    <Link href="/free-tools/break-even" className="flex items-center gap-3 px-4 py-3 text-gray-300 hover:bg-[#2a2a2a] hover:text-white rounded-lg transition-colors">
                    ...
                    <Link href="/free-tools/menu-pricing" className="flex items-center gap-3 px-4 py-3 text-gray-300 hover:bg-[#2a2a2a] hover:text-white rounded-lg transition-colors">
                      <span className="text-2xl">🍽️</span>
                      <div>
                    ...
                    <Link href="/free-tools/per-plate-pricing" className="flex items-center gap-3 px-4 py-3 text-gray-300 hover:bg-[#2a2a2a] hover:text-white rounded-lg transition-colors">
                      <span className="text-2xl">🍱</span>
                      <div>
                    ...
                    <Link href="/free-tools/startup-cost" className="flex items-center gap-3 px-4 py-3 text-gray-300 hover:bg-[#2a2a2a] hover:text-white rounded-lg transition-colors">
                      <span className="text-2xl">🚀</span>
                      <div>
                    ...
                    <Link href="/free-tools/google-review" className="flex items-center gap-3 px-4 py-3 text-gray-300 hover:bg-[#2a2a2a] hover:text-white rounded-lg transition-colors">
                      <span className="text-2xl">⭐</span>
                      <div>
                    ...
                    <Link href="/free-tools/third-party-fees" className="flex items-center gap-3 px-4 py-3 text-gray-300 hover:bg-[#2a2a2a] hover:text-white rounded-lg transition-colors">
                      <span className="text-2xl">💳</span>
                      <div>
                    ...
                    <Link href="/free-tools" className="block px-4 py-3 text-cyan-400 hover:bg-[#2a2a2a] border-t border-[#2a2a2a] rounded-lg mt-1">
                      View All Tools →
                    </Link>
                  </div>
                </div>
