...
export default function PerPlatePricingCalculator() {
  ...
  // Suggested prices
  const getSuggestedPrice = (foodCostPercent: number) => {
  ...
  const calculateAnnualSavings = (originalCost: number, newCost: number) => {
    ...
    <div className="min-h-screen text-white">
      ...
      <section className="relative py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 mb-8 shadow-[0_0_50px_rgba(56,189,248,0.1)]">
            ...
            <div className="mb-8">
              ...
              <input
                ...
                className="w-full px-4 py-3 backdrop-blur-xl bg-black/40 border-2 border-white/10 rounded-lg focus:border-[#38bdf8] focus:outline-none text-white text-lg transition-colors"
              />
            </div>
            ...
            <div className="mb-8">
              ...
              {/* Instructions */}
              <div className="mb-6 p-4 backdrop-blur-xl bg-[#38bdf8]/10 border border-[#38bdf8]/30 rounded-lg">
              ...
              <div className="space-y-6">
                {ingredients.map((ing) => {
                  ...
                  return (
                    <div key={ing.id} className="backdrop-blur-xl bg-black/40 border-2 border-white/10 rounded-lg p-6 hover:border-[#38bdf8]/50 transition-colors">
                        ...
                        <div className={ing.soldBy === 'each' ? 'md:col-span-3' : ''}>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full pl-8 pr-4 py-3 backdrop-blur-xl bg-black/40 border-2 border-white/10 rounded-lg focus:border-[#38bdf8] focus:outline-none text-white transition-colors"
                              step="0.01"
                            />
                          </div>
                        </div>
                      ...
                      {priceInfo && (
                        <div className="mb-4 p-3 backdrop-blur-xl bg-[#10b981]/10 border border-[#10b981]/30 rounded-lg">
                        ...
                        <div className="md:col-span-2">
                          ...
                          <div className="flex gap-2">
                            <input
                              ...
                              className="flex-1 px-4 py-3 backdrop-blur-xl bg-black/40 border-2 border-white/10 rounded-lg focus:border-[#38bdf8] focus:outline-none text-white transition-colors"
                              step="0.01"
                            />
                            <select
                              value={ing.plateUnit}
                              onChange={(e) => updateIngredient(ing.id, 'plateUnit', e.target.value)}
                              className="px-4 py-3 backdrop-blur-xl bg-black/40 border-2 border-white/10 rounded-lg focus:border-[#38bdf8] focus:outline-none text-white transition-colors"
                        ...
                        <div className="flex items-end justify-end">
                          {ingredients.length > 1 && (
                            <button
                              ...
                              className="px-4 py-3 backdrop-blur-xl bg-[#ef4444]/20 text-[#ef4444] rounded-lg hover:bg-[#ef4444]/30 transition font-semibold border border-[#ef4444]/50"
                            >
                              Remove
                            </button>
                          )}
                        ...
                        <div className="pt-4 border-t border-white/10">
                          <div className="flex flex-wrap items-center gap-3">
                            ...
                            <button
                              ...
                              className="px-3 py-1 backdrop-blur-xl bg-[#ef4444]/20 text-[#ef4444] rounded text-sm font-semibold hover:bg-[#ef4444]/30 transition border border-[#ef4444]/50"
                            >
                              -20%
                            </button>
                            <button
                              onClick={() => adjustPortion(ing.id, -10)}
                              className="px-3 py-1 backdrop-blur-xl bg-[#fbbf24]/20 text-[#fbbf24] rounded text-sm font-semibold hover:bg-[#fbbf24]/30 transition border border-[#fbbf24]/50"
                            >
                              -10%
                            </button>
                            <button
                              onClick={() => adjustPortion(ing.id, 10)}
                              className="px-3 py-1 backdrop-blur-xl bg-[#10b981]/20 text-[#10b981] rounded text-sm font-semibold hover:bg-[#10b981]/30 transition border border-[#10b981]/50"
                            >
                              +10%
                            </button>
                            <button
                              onClick={() => adjustPortion(ing.id, 20)}
                              className="px-3 py-1 backdrop-blur-xl bg-[#38bdf8]/20 text-[#38bdf8] rounded text-sm font-semibold hover:bg-[#38bdf8]/30 transition border border-[#38bdf8]/50"
                            >
                              +20%
                            </button>
            ...
            {/* Volume Input */}
            <div className="mb-8 p-4 backdrop-blur-xl bg-white/5 border border-white/10 rounded-lg">
              <label className="block text-sm font-semibold text-gray-300 mb-2">
              ...
              <input
                ...
                placeholder="100"
                className="w-full md:w-64 px-4 py-3 backdrop-blur-xl bg-black/40 border-2 border-white/10 rounded-lg focus:border-[#38bdf8] focus:outline-none text-white transition-colors"
              />
            ...
            {totalPlateCost > 0 && (
              <div className="border-t-2 border-white/10 pt-8">
                ...
                {/* Total Plate Cost */}
                <div className="backdrop-blur-xl bg-gradient-to-r from-[#38bdf8]/20 to-[#0ea5e9]/20 border-2 border-[#38bdf8] p-6 rounded-lg mb-8">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                  {prices.map((option, index) => (
                    <div 
                      key={index}
                      className="backdrop-blur-xl bg-white/5 border-2 border-white/10 rounded-lg p-6 hover:border-[#38bdf8] transition-colors"
                    >
                ...
                <div className="backdrop-blur-xl bg-[#a855f7]/10 border-2 border-[#a855f7] p-6 rounded-lg mb-8">
                ...
                <div className="backdrop-blur-xl bg-white/5 border border-white/10 p-6 rounded-lg">
                    ...
                    <table className="w-full">
                      ...
                      <tbody>
                        {ingredients.filter(ing => ing.name && ing.casePrice && ing.plateAmount).map((ing) => {
                          ...
                          return (
                            <tr key={ing.id} className="border-b border-white/10">
          ...
          {totalPlateCost > 0 && platesPerWeek && (
            <div className="backdrop-blur-xl bg-gradient-to-r from-[#10b981]/20 to-[#059669]/20 border-2 border-[#10b981] rounded-2xl p-8 mb-8 shadow-[0_0_80px_rgba(16,185,129,0.15)]">
              <h3 className="text-2xl font-bold text-white mb-6 text-center">
                The Power of Portion Control
              </h3>
              
              <div className="grid md:grid-cols-3 gap-6">
                <div className="backdrop-blur-xl bg-white/5 p-6 rounded-lg border-2 border-[#10b981]">
              ...
              <div className="mt-6 p-4 backdrop-blur-xl bg-[#fbbf24]/10 border-2 border-[#fbbf24] rounded-lg">
                <p className="text-sm text-gray-300">
          ...
          {/* CTA Section */}
          <div className="backdrop-blur-xl bg-gradient-to-br from-[#38bdf8]/20 to-[#0ea5e9]/20 border-2 border-[#38bdf8] rounded-3xl p-8 text-center shadow-[0_0_80px_rgba(56,189,248,0.15)]">
